...
def _ask_wolfram(
    expression: str, decimal_precision: int
) -> Union[int, float, str]:
    """
    ...
    url = (
        f"http://api.wolframalpha.com/v2/query?input={url_exp}&appid={APP_ID}"
...
def calculate(
    expression: str, decimal_precision: int = 5, wolfram: bool = False
) -> Union[int, float, str]:
    """
